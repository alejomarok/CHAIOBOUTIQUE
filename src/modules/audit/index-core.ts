...
// db.ts) so this stays importable from a plain Node context (Playwright's
// test-runner process, prisma/seed.ts via `tsx`) — see src/modules/audit/index.ts
// and ARCHITECTURE.md. Every Next.js-side module keeps importing
// "@/modules/audit" unchanged; that wrapper just re-exports this file.
